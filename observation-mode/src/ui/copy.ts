export const COPY = {
  open: "Open the Glass",
  openAria: "Open immersive reading mode",
  skip: "Skip the ritual",
  skipAria: "Skip the opening and begin reading",
  returnArchive: "Return to Archive",
  hear: "Hear the Glass",
  focus: "Focus the Glass",
  lantern: "Lantern",
  lanternAriaOff: "Lantern — focus the current paragraph",
  lanternAriaOn: "Lantern on — focusing the current paragraph",
