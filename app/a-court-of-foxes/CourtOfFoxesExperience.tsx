...
const baseChapters: Chapter[] = [
  ...
  },
  {
    ...
    "body": [
      ...
      "“Yes,” Kitsu said. “They contract diseases.”",
      "“They dance,” Marok corrected.",
      "Kitsu sighed. “They riot.”",
      "“They kiss,” Marok said, pushing his lips out toward me.",
      "“They also riot after kissing,” Kitsu said.",
      "Marok pointed at him as if he had just proven a sacred theorem. “Passion.”",
      "“Poor city planning,” Kitsu said, frowning.",
      ...
      "Marok followed his gaze and frowned. “That is a little on the nose, even for mortals.” The scale was beautiful in the way divine tools often were: too balanced to be decorative, too sharp to be safe. Its central beam was blackened gold. Two shallow pans hung from chains so fine they looked like threads of light.",
      "Kitsu’s face had gone pale beneath the warm brown of his borrowed skin. “That should not be here,” he said.",
      "Marok leaned closer. “Is it real?”",
      "“No.” Kitsu’s answer came too quickly. “It cannot be.”",
      "I looked at the scale again. It did not glow. It did not sing. It sat above a bar while a mortal woman below it poured beer into chipped mugs and shouted at a man to stop licking the dice. “Perhaps it is a replica,” I said.",
      "Kitsu’s eyes did not leave it. “Perhaps.”",
      "Marok brightened. “Excellent. Then we should enjoy ourselves.”",
      "“That is not what perhaps means.”",
      ...
      "Kitsu stared at the cups as if one had confessed to murder.",
      "Marok lifted his immediately. “To mortal customs!”",
      "“To limited censure,” I said, because apparently my mouth had survived the transformation with all its worst impulses intact.",
      ...
      "Marok, who had finished his drink and possibly part of his common sense, leaned toward me. “Dance with me.”",
      "“No,” I said, bright and pleasant as a door closing.",
      "“You don’t know what I’m asking,” Marok replied.",
      "I smiled. “I have been told that before. It ended in bloodshed.”",
      "Marok’s grin flashed. “And yet your hair looks magnificent.”",
      "I lifted my chin. “That has nothing to do with you.”",
      "“Most miracles don’t,” Marok said, sighing.",
      "Kitsu made a soft, pained sound.",
      ...
      "“Too much?” he asked, his thick, hunter-green brows knitting together. The question was quiet enough that I almost missed it beneath the fiddle. That was what made it dangerous.",
      "“No,” I said.",
      "His smile returned, but softer at the edges. “Then stop thinking like you still have four paws.”",
      "“I miss the paws,” I whispered.",
      "“You do have excellent paws,” Marok flirted.",
      "“Do not flatter my lost paws,” I warned, smiling.",
      "“I would never disrespect them by lying!” Marok exclaimed.",
      ...
      "The song ended with a crash of drum and shouting. I was breathing too fast. Marok was too. Good. Then Kitsu appeared at the edge of the dance floor. “I require one dance,” he said.",
      "Marok coughed. “Require? That’s your line, bro?”",
      "Kitsu looked at him. “Yes, bro.”",
      "“With her?” Marok asked.",
      "Kitsu growled. “With Jem.”",
      ...
      "“You dance well for someone who disapproves of motion,” I said.",
      "Kitsu placed his lips near my ear. “I disapprove of unnecessary risk.”",
      "A chill ran down my spine, but I batted my eyelashes. “Is this necessary?”",
      "His gaze flicked to Marok, then back to me. “Clarifying.”",
      "“Clarifying what?”",
      "“That you are capable of wanting danger without surrendering to it.”",
      "My breath caught. The mortal room blurred around him. His eyes were still amber, still severe, but there was heat beneath the severity. Contained, not absent. A flame hidden behind temple doors. “And you?” I asked.",
      "His jaw tightened. The song pulled us closer by half an inch. Only half. My new human body noticed as if it were a scandal. “I am capable of wanting many things,” Kitsu said. “That does not make them lawful.”",
      ...
      "Marok laughed too loudly from the table. “You think you’re so cool, Golden Boy?”",
      "I returned to them with as much dignity as a barefoot woman in a too-thin gown could manage. Marok had acquired another cup. No one had given it to him. This was concerning.",
      "“How many have you had?” Kitsu asked.",
      "Marok looked into the cup as if the answer might be swimming there. “This one? One.”",
      "“That is not what I asked,” Kitsu growled.",
      "Marok’s eyes narrowed into slits. “Then ask better questions.”",
      ...
      "At that exact moment, the golden scale above the bar chimed. Not loudly. Not enough for the mortals to notice over the music, but the sound slipped through me like a needle through silk. Kitsu turned first. The smoky glass case had cracked. A single line split it from top to bottom. Inside, the scale trembled. Marok blinked at it with alcohol-bright eyes. “That is definitely not a replica.”",
      "“No,” Kitsu said. The word had lost all irritation. Now it was fear.",
      ...
      "“I am not impressed by theft.”",
      "“Borrowing.”",
      "“I am not impressed by borrowing from glass cases either.”",
      "Kitsu shoved through the crowd. “Put one hand on that case and I will break it for you.”",
      "Marok’s grin faltered. “You are very possessive of objects for a man who claims to worship justice.”",
      "Kitsu snarled. “That is Heba’s Scale of Judgment.”",
      ...
      "My stomach dropped. “Marok,” I said. “Get down.”",
      "But Marok had already reached for the scale. His fingers closed around the blackened-gold beam. Green light sparked once under his skin.",
      "Kitsu lunged. “No!”",
      "Marok twisted away, half laughing, half startled. “I have it.”",
      "“You should not have it!” Kitsu declared.",
      "Marok whined. “I know that now!”",
      "Kitsu seized the other end of the scale. The two of them froze on the bar, War and Justice in borrowed flesh, each gripping one side of a thing neither mortal nor fox should have been touching.",
      ...
      "“Kitsu,” I said carefully. His eyes did not leave the scale. “Let go, Marok.”",
      "“You let go!” Marok growled.",
      "“You are intoxicated,” Kitsu said.",
      "“You are insufferable!” Marok snarled.",
      "Kitsu tugged. “You are endangering the court.”",
      "Marok tugged harder. “You are always the court!” The words tore out of Marok with more force than he seemed to expect. Kitsu flinched. Only a little. Enough.",
  ...
  },
  {
    ...
    "body": [
      ...
      "Marok made no attempt to be dignified. He swore loudly enough to make three mortals gasp and one elderly man choke on his sausage. “What is that?” Marok snapped.",
      "Kitsu’s jaw worked. “A summons.”",
      "“That is not the dawn bell.”",
      "“No.” Something cold moved under the word. “It is worse.”",
      ...
      "Kitsu turned on him. “You touched the Scale!”",
      "Marok flinched as if the words were a hand across his face. “I know,” Marok said.",
      "“Do you understand what you touched? The Scale of Judgment is not a toy above a mortal bar. It is the one instrument capable of halting a Judgment once the Bell begins.”",
      "“I know that now!” Marok exclaimed.",
      "“You knew enough before.”",
      "“I was drunk!”",
      "“You were warned.”",
      "Marok’s eyes flashed green. “By you? You warn everyone. It’s actually your love language.”",
      "Kitsu sighed. “Do not make this charming.”",
      "“I am not trying to make this charming.”",
      "The chamber went still. For a moment the glittering fool fell away, and underneath him was someone younger. Not in years. In terror. He looked at me, then away. “I thought it was a replica,” he said. “I thought—”",
      "“You thought impressing Jem mattered more than listening.”",
      "That landed. Hard.",
      ...
      "The mask from the Mortal Hour appeared in the glass, its candle-flame eyes guttering low. “Return incomplete.”",
      "“No,” Kitsu said. “Return is impossible. There is a difference. The assistant seals are severed. The tails are unaccounted. Our mortal forms are unstable. The Judgment Bell is active.”",
      "“Judgment?” I asked.",
      "The mask’s eyes turned toward me. I wished they would stop doing that. “Commencement has begun.”",
      "“That is not possible,” Kitsu said.",
      "“Many impossible things are developing a habit tonight,” Marok muttered.",
      ...
      "Marok stared at our joined hands. Kitsu stared at the place where his hand touched my waist. I stared at both of them and decided I would rather be thrown through another floor than discuss it. “Stabilization is temporary,” the mask said.",
      "“Helpful,” I said through my teeth. “Anything else?”",
      "The candle-eyes dimmed. “Recover tails. Recover Scale. Halt false commencement.”",
      "“False?” Kitsu asked sharply.",
      "The mirror shuddered. For a moment, something moved behind the mask. Silver. Pale as old moonlight. Then gone. The mask’s mouth opened wider than it should have been able to. “Recover tails. Recover Scale.” The black mirror cracked. And the message vanished.",
      "Kitsu released me as if the contact had burned him. Marok did not release my hand until I looked at our fingers and lifted one brow. He let go at once. “Temporary stabilization,” he said, because apparently death, theft, and divine catastrophe had not cured him of being unbearable. “That sounds romantic.”",
      "“That sounds medical,” Kitsu said.",
      "“That sounds like both of you are about to become my second and third least favorite problem,” I said.",
      "Marok looked almost pleased. “Only second and third?”",
      "“The missing tail is first.” That killed his smile again.",
      "“The Scale broke in two. One half went toward the east-facing windows. One toward the cellar door. Our tails vanished at the same time. That is not a coincidence.”",
      "Kitsu’s gaze sharpened. “Scale and witness are bound. A Judgment instrument cannot move without a witness thread. The halves may have followed tail signatures.”",
      "“Or carried them,” I said.",
      ...
      "The pearlescent film shimmered, and for one heartbeat I saw beneath it: not water, not basin, but a narrow alley packed with cages. Tails hung inside them like trapped fire. Scarlet. Cobalt. Green. Gold. Rose. Then the vision vanished. “I saw cages,” I said.",
      "Kitsu went very still. “Where?”",
      "“I do not know. An alley. Iron bars. Too much noise. Tails like lanterns.”",
  ...
  },
  {
    ...
    "body": [
      ...
      "Marok lifted one hand to the blood at his temple, looked at the red on his fingers, and smiled as if the sight had offended him by being too honest. “It is a market.”",
      "“Helpful,” I said.",
      "“For tails,” Kitsu added.",
      "The words struck the chamber colder than the Bell. “Stolen things. Forbidden things. Pieces of spirit no lawful court would admit can be priced.”",
      "“And yet they are,” Marok said.",
      "“The Tail Market is a rumor,” Kitsu said. “A disgrace told by foxes who wish to frighten other foxes into better behavior.”",
      "Marok gave a very small laugh. It had no joy in it. “You sound almost convincing.”",
      "Kitsu’s calm changed shape. Not broke. Never that. It gathered itself into something narrower. “You know where it is.”",
      "“I know where it was.”",
      "“That is not denial.”",
      "“No,” Marok said. “It is grammar.”",
      ...
      "For once, there was no wink waiting in Marok’s eyes. “The Tail Market was where I was going tonight,” he said.",
      "The chamber went so quiet I heard one drop of water fall from an empty hook into an empty basin. “You were going,” Kitsu said, “to a criminal market during a sanctioned Mortal Hour.”",
      "“Not for shopping.”",
      "“How reassuring.”",
      "“I received a warning.”",
      "Gold light tightened. “When?”",
      "Marok looked at me again. Wrong choice. “Before Attendance,” he said.",
      ...
      "Kitsu stared at the place where the words had been. “Who sent it?”",
      "“I do not know.”",
      "The gold wire pulsed. Marok hissed and clutched his wrist. “Truth,” Kitsu said.",
      "“I do not know.”",
      "Again the gold pulsed. This time Marok did not flinch. The answer held. Kitsu looked almost disappointed.",
      "“You knew there might be danger to the assistants,” I said.",
      "“I knew there might be a threat.”",
      "“So you told us?” His silence answered first. My hand lifted. I do not remember deciding to raise it. I only remember seeing it there, pale and shaking, suspended between us with all five fingers spread. Marok did not move away. That made it worse. He stood there with blood at his temple and no tail behind him and fear in his eyes, and he looked like he might let me strike him if it gave the moment somewhere to go. I did not. Not because he did not deserve it. Because he would have accepted it, and I refused to become another pretty punishment arranged for someone else’s relief. I lowered my hand. The space between us did not heal. It only learned to stand upright.",
      "“You used my goddess’s command,” I said. “You used my cage as your cover.”",
      "“No.” The gold wire snapped bright. Marok sucked in a breath. “I used the allowance as cover. I did not know the God of Beauty would order Jem into it.” The wire dimmed. Truth. Annoyingly.",
      "“You wanted to take me,” Kitsu said.",
      "“Yes. To keep me away from the court.”",
      "“To make you look at the warning before you bury it under procedure.”",
      "“I would have reported it.”",
      "“Yes,” Marok said. “That was the problem.”",
      "Kitsu went very still. Marok’s voice cracked at the edge and immediately tried to pretend it had not. “If someone inside the court wanted no foxes present for Judgment, then reporting the warning to the court seemed unwise.”",
      "“And drinking beneath the Scale of Judgment seemed wise?”",
      "“No,” Marok said. No joke. No grin. Just the word. It landed harder that way.",
      ...
      "“Beauty magic,” said the God of Justice from the mirror.",
      "My goddess’s smile did not move. “Careful.”",
      "He looked at me. So did the others. Kitsu stepped half a pace in front of me. I noticed. So did my goddess. I should have disliked it. I did dislike it. I also did not ask him to move. “The glamour on the basin is Beauty-aspected,” Kitsu said, “but Jem did not cast it.”",
      "“Can you attest to that under oath?”",
      "Kitsu paused. Tiny. Terrible. My heart heard it anyway. “I can attest,” he said carefully, “that she was with us when the tails vanished.”",
      "Not the same answer. My goddess’s magenta eyes slid to me. “Jem, darling.”",
      "I hated darling more than I hated marble. “Did you dress the theft?”",
      "The question was gentle. It should have come with a knife so at least everyone could admire the honesty. “No, my goddess.”",
      "“Did you recognize the dressing?”",
      "“Yes.”",
      "A murmur moved through the reflected court. Marok stepped forward. Too late, but with heat. “She saw through it. That is different.”",
      ...
      "The God of Justice turned to Kitsu. “Recover the Scale. Recover the tails. The false commencement must be halted before the first mortal verdict locks.”",
      "“Authority?” Kitsu asked.",
      "The God of Justice lifted the cracked scroll. “Improvised.”",
      "Kitsu looked as if someone had handed him a burning coal and called it breakfast. Marok looked delighted for half a second before remembering why delight had been made illegal tonight.",
      ...
      "I turned back to the basin. The pearlescent film had thickened. It swirled lazily across the water, smug as cream over poison. Jasmine over spoiled milk. My magic, but not mine. Or near enough to be blamed. “I need to touch it,” I said.",
      "“No,” Kitsu and Marok said together.",
      "That annoyed me so much I almost smiled. “I was not asking,” I said, batting my lashes.",
      "Kitsu’s jaw tightened. “It may be keyed to your power.”",
      "“Then it will answer me.”",
      "“It may be keyed to hurt you.”",
      ...
      "“Yes.”",
      "Marok swallowed. “Where?”",
      "“The Tail Market.” His eyes closed for half a heartbeat. Guilt looked wrong on him. Too plain. Too mortal.",
      "“Can you lead us there?” Kitsu asked him.",
      "Marok opened his eyes. “Yes.” Truth. No gold wire needed.",
      "I stepped between them before Kitsu could choose the sharpest of his lawful things. “We recover one tail first.”",
      "“Yours,” Marok said.",
      "“No.” Both of them stared. “My tail was nearest in the vision because the glamour wanted me to reach for it. That’s bait.”",
      "Kitsu’s expression shifted, calculation returning like armor sliding into place. “Scarlet was unstable in the court mirror.”",
      "“Saroka,” I said.",
      "The God of Fortune’s fox. My friend. My girl, if immortals who belonged to gods were allowed such mortal little words. The memory of her scarlet tail lying absent behind her made something hot and ugly rise in my throat. “We find Saroka’s tail first. Then we follow whatever it knows.”",
      "Marok nodded at once.",
      "Kitsu studied me. “That is a dangerous choice.”",
      "“Good,” I said. “I am in the mood to disappoint safety.”",
      "Marok’s mouth twitched. Kitsu did not smile, but something in his eyes warmed despite itself.",
