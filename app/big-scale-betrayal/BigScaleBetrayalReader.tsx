...
const chapterMedia: ChapterMedia[] = [
  ...
  },
  {
    ...
    after: 58,
    type: "image",
    src: `${assetBase}/chapter8-ahmose-wraps-hands.png`,
    fit: "cover",
    alt: "Ahmose kneels before Heba and wraps her injured hand with clean linen",
    caption: "After the chamber takes its fee, Ahmose kneels with clean linen and very careful hands.",
  },
  {
    chapterNumber: 9,
    after: 4,
